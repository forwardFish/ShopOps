# Task T10 - operator-runbook-env-docs

## 执行命令
```powershell
Set-Location -LiteralPath "D:\lyh\agent\agent-frame\ShopOps"
codex exec "execute D:\lyh\agent\agent-frame\ShopOps\docs\auto-execute\shopops-tasks\T10-operator-runbook-env-docs.md; write result JSON and HANDOFF; do not stop after planning"
```
...
| type | command | path |
| --- | --- | --- |
| result | write result | `docs/auto-execute/results/T10.json` |
| handoff | write handoff | `docs/auto-execute/latest/T10-HANDOFF.md` |
| logs | write logs | `docs/auto-execute/logs/T10/` |
