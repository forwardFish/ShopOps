# Task T09 - local-test-suite-and-secret-guard

## 执行命令
```powershell
Set-Location -LiteralPath "D:\lyh\agent\agent-frame\ShopOps"
codex exec "execute D:\lyh\agent\agent-frame\ShopOps\docs\auto-execute\shopops-tasks\T09-local-test-suite-and-secret-guard.md; write result JSON and HANDOFF; do not stop after planning"
```
...
| type | command | path |
| --- | --- | --- |
| result | write result | `docs/auto-execute/results/T09.json` |
| handoff | write handoff | `docs/auto-execute/latest/T09-HANDOFF.md` |
| logs | write logs | `docs/auto-execute/logs/T09/` |
...
## 输出文件
- `local-test-suite-and-secret-guard`
