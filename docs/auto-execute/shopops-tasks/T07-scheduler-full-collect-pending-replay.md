# Task T07 - scheduler-full-collect-pending-replay

## 执行命令
```powershell
Set-Location -LiteralPath "D:\lyh\agent\agent-frame\ShopOps"
codex exec "execute D:\lyh\agent\agent-frame\ShopOps\docs\auto-execute\shopops-tasks\T07-scheduler-full-collect-pending-replay.md; write result JSON and HANDOFF; do not stop after planning"
```
...
| type | command | path |
| --- | --- | --- |
| result | write result | `docs/auto-execute/results/T07.json` |
| handoff | write handoff | `docs/auto-execute/latest/T07-HANDOFF.md` |
| logs | write logs | `docs/auto-execute/logs/T07/` |
...
## 输出文件
- `scheduler-full-collect-pending-replay`
