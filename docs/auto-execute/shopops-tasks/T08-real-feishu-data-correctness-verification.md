# Task T08 - real-feishu-data-correctness-verification

## 执行命令
```powershell
Set-Location -LiteralPath "D:\lyh\agent\agent-frame\ShopOps"
codex exec "execute D:\lyh\agent\agent-frame\ShopOps\docs\auto-execute\shopops-tasks\T08-real-feishu-data-correctness-verification.md; write result JSON and HANDOFF; do not stop after planning"
```
...
| type | command | path |
| --- | --- | --- |
| result | write result | `docs/auto-execute/results/T08.json` |
| handoff | write handoff | `docs/auto-execute/latest/T08-HANDOFF.md` |
| logs | write logs | `docs/auto-execute/logs/T08/` |
...
## 输出文件
- `real-feishu-data-correctness-verification`
