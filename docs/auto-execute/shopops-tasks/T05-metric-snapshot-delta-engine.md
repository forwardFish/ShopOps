# Task T05 - metric-snapshot-delta-engine

## 执行命令
```powershell
Set-Location -LiteralPath "D:\lyh\agent\agent-frame\ShopOps"
codex exec "execute D:\lyh\agent\agent-frame\ShopOps\docs\auto-execute\shopops-tasks\T05-metric-snapshot-delta-engine.md; write result JSON and HANDOFF; do not stop after planning"
```
...
| type | command | path |
| --- | --- | --- |
| result | write result | `docs/auto-execute/results/T05.json` |
| handoff | write handoff | `docs/auto-execute/latest/T05-HANDOFF.md` |
| logs | write logs | `docs/auto-execute/logs/T05/` |
