...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Run this many real scheduled cycles, then exit. Use 3 for a roughly three-hour jittered acceptance test.",
    )
    ...
    while True:
        ...
        print(f"Next ShopOps hourly import starts in {delay} seconds.", flush=True)
        time.sleep(delay)
