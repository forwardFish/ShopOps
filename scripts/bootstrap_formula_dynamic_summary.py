...
def summary_formulas(source_names: dict[str, Any], product_rules: list[ProductRule] | None = None) -> dict[str, dict[str, str]]:
    ...
    return {
        ...
        "数据状态": {"expression": 'IF([订单数]=0,"partial",IF([投流记录数]=0&&[达人佣金]=0,"partial","normal"))', "formatter": ""},
        "缺失项": {"expression": 'IF([订单数]=0,IF([投流记录数]=0&&[达人佣金]=0,"订单,投入","订单"),IF([投流记录数]=0&&[达人佣金]=0,"投入",""))', "formatter": ""},
